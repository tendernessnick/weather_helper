...
const S = {
  ...
  'recent.empty': ['近 3 小时没有球友上报——到场上报一次，帮大家看清实况', '近 3 小時沒有球友上報——到場上報一次，幫大家看清實況', 'No reports in the last 3h — report from the court to help everyone'],
  ...
  'ins.relQuestion': ['这一条回答：预报的数字本身可不可信', '這一條回答：預報的數字本身可不可信', 'Whether the forecast numbers themselves are trustworthy'],
  ...
  'ins.decayQuestion': ['这一条回答：隔天的预报能不能信、提前几天订场该信什么', '這一條回答：隔天的預報能不能信、提前幾天訂場該信什麼', 'Whether next-day forecasts hold, and what to trust when booking ahead'],
  ...
  'ins.hourQuestion': ['这一条回答：哪些时段的"没雨"要打个问号（漏报 = 实际下了但预报没说）', '這一條回答：哪些時段的「沒雨」要打個問號（漏報 = 實際下了但預報沒說）', 'Which hours\' "no rain" deserves suspicion (miss = it rained but none was forecast)'],
  'ins.rankTitle': ['哪个球场的预报最靠谱？', '哪個球場的預報最靠譜？', "Which court's forecasts score best?"],
  'ins.rankQuestion': ['这一条回答：同样是预报，在哪被骗的概率小一点', '這一條回答：同樣是預報，在哪被騙的概率小一點', 'Same forecasts — where are you less likely to be fooled?'],
  ...
  'ins.trendQuestion': ['这一条回答：最近一两周和之前比，预报是在变准还是变差', '這一條回答：最近一兩週和之前比，預報是在變準還是變差', 'Whether the last week or two beats the earlier window'],
  ...
  'ins.dryQuestion': ['这一条回答：同样的天气下，哪片场地十年来的下雨底数更低——先天差异，与预报无关', '這一條回答：同樣的天氣下，哪片場地十年來的下雨底數更低——先天差異，與預報無關', 'Which locations have the lowest 10-year rain base rate — built-in, forecast-independent'],
  ...
  'ins.disQuestion': ['这一条回答：Open-Meteo 和天文台临近预报说法相反时，历史上谁更常对', '這一條回答：Open-Meteo 和天文台臨近預報說法相反時，歷史上誰更常對', 'When Open-Meteo and the HKO nowcast call it differently, who wins?'],
  ...
  'home.heroSub': ['出发前告诉你哪片场会下雨，到场后 30 秒上报实况——你的每一次上报，都让下一次决策更准。', '出發前告訴你哪片場會下雨，到場後 30 秒上報實況——你的每一次上報，都讓下一次決策更準。', "Before you leave: which courts stay dry. At the court: report reality in 30 seconds. Every report makes the next decision sharper."],
  ...
  'home.step1Body': ['48 小时逐小时降雨概率、全港雨团地图、还有"哪个时段最稳"的排行——帮你挑球场、挑时段。', '48 小時逐小時降雨概率、全港雨團地圖，還有「哪個時段最穩」的排行——幫你挑球場、挑時段。', 'Hourly rain chances 48h ahead, a citywide rain-cluster map, and a "steadiest hour" ranking — pick the court and the slot.'],
  'home.step2Title': ['② 到场后：报实况', '② 到場後：報實況', '② At the court: report'],
  'home.step2Body': ['你就在球场？点一下"没雨 / 小雨 / 中雨 / 大雨"。这是全香港最快的实况——因为是你亲眼看到的天。', '你就在球場？點一下「沒雨 / 小雨 / 中雨 / 大雨」。這是全香港最快的實況——因為是你親眼看到的天。', "You're there? Tap no rain / light / moderate / heavy. The fastest ground truth in town — it's the sky you're standing under."],
  'home.step3Title': ['③ 越用越准：自动对账', '③ 越用越準：自動對賬', '③ Sharper every week: auto-verified'],
  'home.step3Body': ['本站持续把"预报当时怎么说"和"实际下没下"自动对账，告诉你各家预报在这个球场该信几成。', '本站持續把「預報當時怎麼說」和「實際下沒下」自動對賬，告訴你各家預報在這個球場該信幾成。', 'We reconcile every forecast against what actually fell, court by court — so you know exactly how much to trust each source.'],
  'home.pulseTitle': ['刚刚有球友上报', '剛剛有球友上報', 'Fresh from the courts'],
  'home.pulseEmpty': ['近 6 小时还没有人上报——到场上报一次，成为今天的第一个。', '近 6 小時還沒有人上報——到場上報一次，成為今天的第一個。', 'No reports in the last 6h — be today\'s first from the court.'],
  'home.callTitle': ['你的 30 秒，全港球友的晴雨表', '你的 30 秒，全港球友的晴雨表', "Your 30 seconds, every player's forecast"],
  'home.callBody': ['这个项目没有付费数据源，靠的就是到场上报。你点一次按钮，某个正在纠结"去不去"的球友就能看到真相。', '這個項目沒有付費數據源，靠的就是到場上報。你點一次按鈕，某個正在糾結「去不去」的球友就能看到真相。', 'No paid data feeds here — just players reporting from the court. One tap from you is ground truth for someone still deciding.'],
